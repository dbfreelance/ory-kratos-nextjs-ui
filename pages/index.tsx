...
const SignedOut = () => (
  <>
    In this demo you might want to: <br></br> {' '}
    <a href={'/api/.ory/self-service/registration/browser'}>
    <button className={styles.button}>Sign Up</button>
    </a>{' '}
     <a href={'/api/.ory/self-service/login/browser'}>
      <button className={styles.button}>Sign In</button></a>{' '}
    <a href={'/api/.ory/self-service/recovery/browser'}>
      <button className={styles.button}>Recover your account</button></a>{' '}
    {' '}
...
const Home: NextPage = () => {
  ...
  return (
    ...
    <div className={styles.container}>
      <Head>
        <title>NTSprint Authentication Test</title>
        <meta name="description" content="Generated by create next app" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <main className={styles.main}>
      <div><img src="https://ntsprint.com/wp-content/uploads/2019/11/Logotipo.png" alt="W3Schools.com"></img></div>
      <div><p>&nbsp;</p></div>
        <h1 className={styles.title}>
          {session ? (
            ...
            <>
              NTSprint Test Authentication using {' '}<a href="https://reactjs.org/docs/hooks-intro.html">React Hooks</a>,{' '}  <a href="https://ant.design/">Ant Design</a> and{' '}
